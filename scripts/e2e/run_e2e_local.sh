...
# Forward Stripe events to the controller endpoint used by the app
stripe listen --forward-to http://localhost:8080/api/webhooks/stripe --events payment_intent.succeeded,payment_intent.payment_failed &
STRIPE_PID=$!
